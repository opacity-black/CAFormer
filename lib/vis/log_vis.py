...
log_name = 'caiatrack-caiatrack_uce_st_onlyuav'
cycle_num = 8
...
val_loss_total = moving_average(np.array(val_loss_total.mean(-1)), 1)
print(val_loss_total.shape)
print(val_loss_total)
print(val_loss_total.min())
plt.plot(val_loss_total)
plt.savefig(f"loss_img/{log_name}_val_loss.png")
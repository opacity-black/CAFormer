...
def generate_mask_cond(cfg, bs, device, gt_bbox):
    ...
    if cfg.MODEL.BACKBONE.CTE_TEMPLATE_RANGE == 'ALL':
        box_mask_z = None
    elif cfg.MODEL.BACKBONE.CTE_TEMPLATE_RANGE == 'CTR_POINT': # CTR_POINT is selected by Ostrack
    ...
    elif cfg.MODEL.BACKBONE.CTE_TEMPLATE_RANGE == 'CTR_REC':
    ...
    elif cfg.MODEL.BACKBONE.CTE_TEMPLATE_RANGE == 'GT_BOX':

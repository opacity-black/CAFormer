...
def parameters(yaml_name: str):
    ...
    # params.checkpoint = "/media/data2/zhaogaotian/OSTrackATSRGBT/tracking/output/checkpoints/train/ostrack_ats/vitb_256_mae_ce_32x4_ep300/OSTrack_ats_ep0060.pth.tar"

...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='ostrack', choices=['ostrack', 'caformer', 'ostrack_twobranch'],
...
if __name__ == "__main__":
    ...
    elif args.script == "caformer":    # 多模态测速
        
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_caformer
        model = model_constructor(cfg, training=False)
        model.eval()
        # get the template and search
...
| 3080ti               | FPS   | 备注          |
| -------------------- | ----- | ------------- |
| ostrack_twobranch    | 69.61 | 70            |
| ostrack_twobranch_ce | 80.24 | 80 (baseline) |
| caiatrack_st         | 59.77 | 60            |
| caiatrack_uce_st     | 70.59 | 71 (ours)     |
